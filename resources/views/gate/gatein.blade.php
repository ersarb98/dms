        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('gate.search') }}" method="GET">
                            <div class="form-group">
                                <label for="containerNumber">Nomor Container</label>
                                <input type="text" name="containerNumber" id="containerNumber" class="form-control" placeholder="Enter container number">
                            </div>
                            ...
                            <ul class="list-group">
                                @foreach($jobOperations as $jobOperation)
                                    <li class="list-group-item">
                                        ...
                                        <form action="{{ route('gate.setGateIn', $jobOperation->id) }}" method="POST" class="mt-2">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit" class="btn btn-success">Set Gate In</button>
                                        </form>
                                    </li>
                                @endforeach
                            </ul>
